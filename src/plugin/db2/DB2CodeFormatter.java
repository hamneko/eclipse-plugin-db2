...
public class DB2CodeFormatter extends CodeFormatter {

	private DefaultCodeFormatterOptions preferences;

	public DB2CodeFormatter() {
	...
	public TextEdit format(int kind, String source, int offset, int length, int indentationLevel,
		...
		try {
			ast = new DB2Language().getASTTranslationUnit(content, scanInfo, includes, null, 0, log, true);
